...
void reshape(int width, int height)
{
   ...
   glLoadIdentity();
   gluPerspective(30.0,1.0,15.0,1000.0);  //Perspective
...
void init(void)
{
   glClearColor(0.0,0.0,0.0,1.0);   /* window will be cleared to sky blue
*/
...
void front()
{
        ...
        output(450,130,"RV University",fonts[2]);
        glColor3f(0.3,0.5,0.8);
        output(475,100,"SOCSE",fonts[3]);
        glColor3f(0.8,0.1,0.2);
        output(300,600,"GRAPHICAL IMPLEMENTATION OF AIRSHOW",fonts[2]);
        glColor3f(1.0,0.0,1.0);
        output(450,500,"SUBMITTED BY :",fonts[0]);
        glColor3f(0.3,0.5,0.8);
        output(225,450,"Pratham K",fonts[2]);
        output(670,450,"S Shreyas",fonts[2]);
        output(180,300,"",fonts[3]);
        output(220,400,"(1RVU22CSE122)",fonts[3]);
        output(660,400,"(1RVU22CSE135)",fonts[3]);
